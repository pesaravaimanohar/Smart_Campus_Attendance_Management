        ...
        <Box sx={{ display: 'flex', height: '100vh', bgcolor: 'background.default' }}>
                        ...
                        <Box>
                            ...
                            {activeSection === 'dashboard' && (
                                <Grid container spacing={4}>
                                    ...
                                    <Grid item xs={12}>
                                        <Paper sx={{ p: 4, borderRadius: 3, bgcolor: 'primary.50', border: '1px dashed', borderColor: 'primary.main', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                            <Box>
                                                <Typography variant="h6" fontWeight="bold" gutterBottom>Quick Actions</Typography>
                                                <Typography color="text.secondary">Upload data files to get started quickly.</Typography>
                                            </Box>
                                            <Box display="flex" gap={2}>
                                                <Button variant="contained" onClick={() => setActiveSection('students')} startIcon={<UploadIcon />} sx={{ bgcolor: 'white', color: 'primary.main', '&:hover': { bgcolor: 'white' } }}>Upload Students</Button>
                                                <Button variant="contained" onClick={() => setActiveSection('faculty')} startIcon={<UploadIcon />} sx={{ bgcolor: 'primary.main', color: 'white' }}>Upload Faculty</Button>
                                            </Box>
                                        </Paper>
                                    </Grid>
                                </Grid>
                                                ...
                                                <TableBody>
                                                    {loading ? (
                                                        ...
                                                        <TableRow key={cls.id} hover sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                                            ...
                                                            <TableCell>
                                                                <Chip label={`Year ${cls.yearLevel}`} size="small" sx={{ bgcolor: 'primary.50', color: 'primary.main', fontWeight: 'bold' }} />
                                                            </TableCell>
            ...
            >
                ...
                <DialogContent>
                    ...
                    <TextField
                        fullWidth label="Class Name (e.g. CSE-A)" margin="dense" variant="outlined"
                        value={newClass.name} onChange={(e) => setNewClass({ ...newClass, name: e.target.value })}
                        sx={{ mb: 2 }}
                    />
                    <TextField
                        fullWidth label="Department (e.g. Computer Science)" margin="dense" variant="outlined"
                    ...
                    <TextField
                        ...
                        value={newClass.yearLevel} onChange={(e) => setNewClass({ ...newClass, yearLevel: parseInt(e.target.value) })}
